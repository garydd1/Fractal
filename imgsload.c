...
/*   Updated: 2023/04/16 18:32:33 by dgarizad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_load_sprites(t_data *data)
{
	...
	data->xpm[G] = mlx_load_xpm42("./images_xpm/grass.xpm42");
	data->xpm[P] = mlx_load_xpm42("./images_xpm/luffyF.xpm42");
	data->xpm[W] = mlx_load_xpm42("./images_xpm/Rocky.xpm42");
	data->xpm[C] = mlx_load_xpm42("./images_xpm/btc.xpm42");
	data->xpm[E] = mlx_load_xpm42("./images_xpm/doorclosed.xpm42");
	ft_load_imgs(data);
	ft_draw_grass(data);
	ft_draw_things(data);
	ft_set_hooks(data);
